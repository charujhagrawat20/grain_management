...
function fill_brand_list($conn, $category_id)
{
...
function fetch_product_details($product_id, $conn)
{
	$query = "
	SELECT * FROM product 
...
function available_product_quantity($conn, $product_id)
{
	$product_data = fetch_product_details($product_id, $conn);
	$query = "
...
function count_total_category($conn)
{
	$query = "
...
function count_total_brand($conn)
{
	$query = "
...
function count_total_product($conn)
{
	$query = "
...
function count_total_order_value($conn)
{
	$query = "
...
function count_total_cash_order_value($conn)
{
	$query = "
	SELECT sum(inventory_order_total) as total_order_value FROM inventory_order 
...
function count_total_credit_order_value($conn)
{
	$query = "
...
function get_user_wise_total_order($conn)
{
	$query = '
